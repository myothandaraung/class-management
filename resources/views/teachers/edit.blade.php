...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-primary">教師の編集</h2>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            <form action="{{ route('teachers.update', $teacher->id) }}" method="POST" class="row g-4" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-select border-0 shadow-sm @error('gender') is-invalid @enderror" 
                                id="gender" 
                                name="gender">
                            <option value="male" {{ old('gender', $teacher->gender) == 'male' ? 'selected' : '' }}>男性</option>
                            <option value="female" {{ old('gender', $teacher->gender) == 'female' ? 'selected' : '' }}>女性</option>
                            <option value="other" {{ old('gender', $teacher->gender) == 'other' ? 'selected' : '' }}>その他</option>
                        </select>
                    </div>
                    @error('gender')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                ...
                <div class="col-md-6">
                    <label for="qualification" class="form-label fw-bold">学歴</label>
                    <div class="input-group">
                        <span class="input-group-text bg-light border-0">
                ...
                <div class="col-md-6">
                    <label for="department_id" class="form-label fw-bold">所属学部</label>
                    <div class="input-group">
                        <span class="input-group-text bg-light border-0">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" 
                               class="form-control border-0 shadow-sm @error('address') is-invalid @enderror" 
                               id="address" 
                               name="address" 
                ...
                <div class="col-md-6">
                    <label for="thumbnail" class="form-label fw-bold">プロフィール画像</label>
                    <div class="input-group">
                        <input type="file" 
                ...
                <div class="col-md-6">
                    <label for="password" class="form-label fw-bold">新しいパスワード</label>
                    <div class="input-group">
                        <span class="input-group-text bg-light border-0">
                            <i class="fas fa-lock"></i>
                        </span>
